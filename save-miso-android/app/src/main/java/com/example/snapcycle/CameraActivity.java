...
import com.example.snapcycle.cameraHelpers.CameraConnectionFragment;
import com.example.snapcycle.cameraHelpers.ImageUtils;
import com.example.snapcycle.cameraHelpers.LegacyCameraConnectionFragment;
import com.example.snapcycle.cameraHelpers.Logger;
import com.example.snapcycle.tflite.Classifier.Device;
import com.example.snapcycle.tflite.Classifier.Model;
...
public abstract class CameraActivity extends AppCompatActivity
    ...
    public Model model = Model.FLOAT;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tfe_activity_camera);
//    getSupportActionBar().setDisplayShowTitleEnabled(false);
        ...
        // UNCOMMENT THIS WHEN WE HAVE MORE THAN 2 ITEMS
    ...
    protected void showResultsInBottomSheet(List<Recognition> results) {
        if (results != null && results.size() >= 3) { // CHANGE >=2 TO >=3 WHEN WE ACTUALLY HAVE 3
