...
public final class Logger {
    ...
    static {
        ...
        IGNORED_CLASS_NAMES.add(com.example.snapcycle.cameraHelpers.Logger.class.getCanonicalName());
    }
    ...
    private static String getCallerSimpleName() {
        ...
        return com.example.snapcycle.cameraHelpers.Logger.class.getSimpleName();
    }
